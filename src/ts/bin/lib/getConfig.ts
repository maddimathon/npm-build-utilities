...
export async function getConfig(
    ...
    let newConfig: Config = {
        ...
        title: await console.prompt.input(
        ...
        launchYear: await console.prompt.input(
    ...
    if ( await console.prompt.bool(
        ...
        newCompleteConfig = {
            ...
            paths: {
                ...
                release: await console.prompt.input(
                ...
                snapshot: await console.prompt.input(
            ...
            stages: {
                ...
                document: await console.prompt.bool(
                ...
                snapshot: await console.prompt.bool(
                ...
                test: await console.prompt.bool(
                    'Include test stage?',
                    level,
                    {
    ...
    const configPath = await console.prompt.select(
    ...
    const force = fs.exists( configPath )
        ? ( await console.prompt.bool(
            'Should the new config file overwrite the current file at `' + configPath + '`?',
            level,
            { msgArgs },
        ) )
        : true;
