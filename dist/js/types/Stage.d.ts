...
import type { Classify, PackageJson, SyncOrAsync, TsConfig } from '@maddimathon/utility-typescript/types';
 ...
 * @since 0.1.0-alpha
 */
export interface Stage<T_Args extends Stage.Args = any, T_SubStage extends string = any> {
    /**
...
export declare namespace Stage {
    ...
    namespace Args {
        ...
        interface Build extends Args {
             ...
             * Whether to include this sub-stage.
             */
            minimize: false | Build.Minimize | ((stage: Stage) => Build.Minimize);
            /**
             * Whether to include this sub-stage.
             *
             ...
             */
            prettify: false | Build.Prettify | ((stage: Stage) => Build.Prettify);
            /**
        ...
        interface Document extends Args {
             ...
             */
            typeDoc: Partial<Omit<typeDoc.TypeDocOptions, "entryPoints">> | ((_stage: Stage) => Partial<Omit<typeDoc.TypeDocOptions, "entryPoints">>);
        }
        /**
        ...
        namespace Release {
            ...
            interface CommitFunction {
                 ...
                 * @return  All relative or absolute paths to add to the commit.
                 *
                 * @deprecated 0.3.0-beta.3.draft — Please return a {@link Release.Commit} object instead.
                 */
    ...
    interface TryerFunction<T_SyncType extends 'async' | 'sync' = 'async' | 'sync'> {
         ...
         */
        <T_Tryer extends (...params: never[]) => unknown, T_FallbackReturn extends any = "FAILED">(tryer: T_Tryer, level: number, params?: Parameters<T_Tryer>, handlerArgs?: Partial<Omit<Errors.Handler.Args, 'exitProcess'>> & {
            exitProcess?: true;
        }, fallbackReturn?: T_FallbackReturn): SyncOrAsync<T_SyncType, ReturnType<T_Tryer>>;
        /**
         * If the `tryer` function *has* params, then they are required.
         *
         * If the handler must exit, then T_FallbackReturn is not possible.
         */
        <T_Tryer extends (...params: unknown[]) => unknown, T_FallbackReturn extends any = "FAILED">(tryer: T_Tryer, level: number, params: Parameters<T_Tryer>, handlerArgs?: Partial<Omit<Errors.Handler.Args, 'exitProcess'>> & {
            exitProcess?: true;
        }, fallbackReturn?: T_FallbackReturn): SyncOrAsync<T_SyncType, ReturnType<T_Tryer>>;
        /**
         * If the `tryer` function has no params, then they are optional.
         ...
         */
        <T_Tryer extends (...params: never[]) => unknown, T_FallbackReturn extends any = "FAILED">(tryer: T_Tryer, level: number, params: Parameters<T_Tryer> | undefined, handlerArgs: Partial<Omit<Errors.Handler.Args, 'exitProcess'>> & {
            exitProcess: false | boolean;
        }, fallbackReturn?: T_FallbackReturn): SyncOrAsync<T_SyncType, ReturnType<T_Tryer> | T_FallbackReturn>;
        /**
         * If the `tryer` function *has* params, then they are required.
         */
        <T_Tryer extends (...params: unknown[]) => unknown, T_FallbackReturn extends any = "FAILED">(tryer: T_Tryer, level: number, params: Parameters<T_Tryer>, handlerArgs: Partial<Omit<Errors.Handler.Args, 'exitProcess'>> & {
            exitProcess: false | boolean;
        }, fallbackReturn?: undefined | T_FallbackReturn): SyncOrAsync<T_SyncType, ReturnType<T_Tryer> | T_FallbackReturn>;
        /**
         * Runs a function, with parameters as applicable, and catches (& handles)
         * anything thrown.
         *
         ...
         */
        <T_Tryer extends (...params: unknown[] | never[]) => unknown, T_FallbackReturn extends any = "FAILED">(tryer: T_Tryer, level: number, params?: Parameters<T_Tryer>, handlerArgs?: Partial<Errors.Handler.Args>, fallbackReturn?: undefined | T_FallbackReturn): SyncOrAsync<T_SyncType, ReturnType<T_Tryer> | T_FallbackReturn>;
    }
}
